...
#Exclusivity
  ggplot(searchk_df, aes(x = K, y = exclus)) +
    geom_point() +
    geom_line() +
...
#Semantic Coherence
  ggplot(searchk_df, aes(x = K, y = semcoh)) +
...
#Residual
  ggplot(searchk_df, aes(x = K, y = residual)) +
...
#Held-out likelihood
  ggplot(searchk_df, aes(x = K, y = heldout)) +
    geom_point(color = "darkgreen") +
    geom_line(color = "darkgreen") +
    labs(title = "Residuals",
         x = "Topic",
         y = "Heldout Likelihood") +
    theme_minimal()
